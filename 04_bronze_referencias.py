...
# DBTITLE 1,Validação Bronze - 1. Total de Registros
# MAGIC %sql
# MAGIC -- 1. QUANTIDADE TOTAL DE REGISTROS EM CADA TABELA BRONZE
# MAGIC
# MAGIC SELECT 'aerodromos' AS tabela, COUNT(*) AS total_registros 
# MAGIC FROM voebem.bronze.aerodromos
# MAGIC UNION ALL
# MAGIC SELECT 'empresas_nacionais', COUNT(*) 
# MAGIC FROM voebem.bronze.empresas_nacionais
# MAGIC UNION ALL
# MAGIC SELECT 'empresas_estrangeiras', COUNT(*) 
# MAGIC FROM voebem.bronze.empresas_estrangeiras
# MAGIC UNION ALL
# MAGIC SELECT 'codigos_operacao', COUNT(*) 
# MAGIC FROM voebem.bronze.codigos_operacao
# MAGIC UNION ALL
# MAGIC SELECT 'vra', COUNT(*) 
# MAGIC FROM voebem.bronze.vra
# MAGIC ORDER BY tabela

# COMMAND ----------

# DBTITLE 1,Validação Bronze - 2. Estrutura: Aeródromos
# MAGIC %sql
# MAGIC -- 2. ESTRUTURA DA TABELA: voebem.bronze.aerodromos
# MAGIC DESCRIBE TABLE voebem.bronze.aerodromos

# COMMAND ----------

# DBTITLE 1,Validação Bronze - 2. Estrutura: Empresas Nacionais
# MAGIC %sql
# MAGIC -- 2. ESTRUTURA DA TABELA: voebem.bronze.empresas_nacionais
# MAGIC DESCRIBE TABLE voebem.bronze.empresas_nacionais

# COMMAND ----------

# DBTITLE 1,Validação Bronze - 2. Estrutura: Empresas Estrangeiras
# MAGIC %sql
# MAGIC -- 2. ESTRUTURA DA TABELA: voebem.bronze.empresas_estrangeiras
# MAGIC DESCRIBE TABLE voebem.bronze.empresas_estrangeiras

# COMMAND ----------

# DBTITLE 1,Validação Bronze - 2. Estrutura: Códigos Operação
# MAGIC %sql
# MAGIC -- 2. ESTRUTURA DA TABELA: voebem.bronze.codigos_operacao
# MAGIC DESCRIBE TABLE voebem.bronze.codigos_operacao

# COMMAND ----------

# DBTITLE 1,Validação Bronze - 3. Amostra: Aeródromos
# MAGIC %sql
# MAGIC -- 3. PRIMEIROS REGISTROS: voebem.bronze.aerodromos
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.aerodromos 
# MAGIC LIMIT 10
...
# DBTITLE 1,Validação Bronze - 3. Amostra: Empresas Nacionais
# MAGIC %sql
# MAGIC -- 3. PRIMEIROS REGISTROS: voebem.bronze.empresas_nacionais
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.empresas_nacionais 
# MAGIC LIMIT 10
...
# DBTITLE 1,Validação Bronze - 3. Amostra: Empresas Estrangeiras
# MAGIC %sql
# MAGIC -- 3. PRIMEIROS REGISTROS: voebem.bronze.empresas_estrangeiras
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.empresas_estrangeiras 
# MAGIC LIMIT 10
...
# DBTITLE 1,Validação Bronze - 3. Amostra: Códigos Operação
# MAGIC %sql
# MAGIC -- 3. PRIMEIROS REGISTROS: voebem.bronze.codigos_operacao
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.codigos_operacao 
# MAGIC LIMIT 10
...
# DBTITLE 1,1. Quantidade total de registros - aerodromos
# MAGIC %sql
# MAGIC -- 1. Quantidade total de registros
# MAGIC SELECT COUNT(*) AS total_registros 
# MAGIC FROM voebem.bronze.aerodromos

# COMMAND ----------

# DBTITLE 1,2. Estrutura da tabela - aerodromos
# MAGIC %sql
# MAGIC -- 2. Colunas disponíveis e tipos de dados (Estrutura)
# MAGIC DESCRIBE TABLE voebem.bronze.aerodromos

# COMMAND ----------

# DBTITLE 1,3. Primeiros registros - aerodromos
# MAGIC %sql
# MAGIC -- 3. Primeiros registros armazenados (Amostra inicial)
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.aerodromos
# MAGIC LIMIT 10
...
# DBTITLE 1,1. Quantidade total de registros - codigos_operacao
# MAGIC %sql
# MAGIC -- 1. Quantidade total de registros
# MAGIC SELECT COUNT(*) AS total_registros 
# MAGIC FROM voebem.bronze.codigos_operacao
...
# DBTITLE 1,2. Estrutura da tabela - codigos_operacao
# MAGIC %sql
# MAGIC -- 2. Colunas disponíveis e tipos de dados (Estrutura)
# MAGIC DESCRIBE TABLE voebem.bronze.codigos_operacao
...
# DBTITLE 1,3. Primeiros registros - codigos_operacao
# MAGIC %sql
# MAGIC -- 3. Primeiros registros armazenados (Amostra inicial)
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.codigos_operacao
...
# DBTITLE 1,1. Quantidade total de registros - empresas_estrangeiras
# MAGIC %sql
# MAGIC -- 1. Quantidade total de registros
# MAGIC SELECT COUNT(*) AS total_registros 
# MAGIC FROM voebem.bronze.empresas_estrangeiras
...
# DBTITLE 1,1. Quantidade total de registros - empresas_nacionais
# MAGIC %sql
# MAGIC -- 1. Quantidade total de registros
# MAGIC SELECT COUNT(*) AS total_registros 
# MAGIC FROM voebem.bronze.empresas_nacionais
...
# DBTITLE 1,2. Estrutura da tabela - empresas_nacionais
# MAGIC %sql
# MAGIC -- 2. Colunas disponíveis e tipos de dados (Estrutura)
# MAGIC DESCRIBE TABLE voebem.bronze.empresas_nacionais
...
# DBTITLE 1,3. Primeiros registros - empresas_nacionais
# MAGIC %sql
# MAGIC -- 3. Primeiros registros armazenados (Amostra inicial)
# MAGIC SELECT * 
# MAGIC FROM voebem.bronze.empresas_nacionais
